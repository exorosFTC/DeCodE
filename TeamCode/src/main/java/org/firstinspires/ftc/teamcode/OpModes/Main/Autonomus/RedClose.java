...
public class RedClose extends ExoMode {
    ...
    private void firstLine() {
        auto.driveTo(new Pose(35, -60, Math.toRadians(270)), 0, 30)
                .moveSystem(() -> system.indexer.home())
                .waitDrive(0.85)
                .driveTo(new Pose(35, -129, Math.toRadians(270)), 0, 30)
    ...
    private void secondLine() {
        auto.driveTo(new Pose(-15, -75, Math.toRadians(270)), 0, 30)
                ...
                .waitDrive(0.9)
                .moveSystem(() -> system.intake.on())
                .driveTo(new Pose(-15, -156, Math.toRadians(270)), 0, 30)
                .waitDrive(0.87)
                ...
                .waitDrive(0.7)
                .driveTo(new Pose(85, -60, Math.toRadians(340)), 30, 30)
                .waitDrive(0.7)
                .moveSystem(() -> {
                    //system.indexer.indexPattern();
                    system.shooter.on();
    ...
    private void thirdLine() {
        auto.driveTo(new Pose(-73, -60, Math.toRadians(270)), 0, 30)
                .waitDrive(0.95)
                .moveSystem(() -> system.intake.on())
                .driveTo(new Pose(-83, -156, Math.toRadians(270)), 0, 30)
                .waitDrive(0.87)
